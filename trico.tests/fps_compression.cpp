...
namespace trico
  {
  void transpose_aos_to_soa_standford_bunny(const char* filename)
    {
  ...
  void compress_vertices_standford_bunny(const char* filename)
    {
  ...
  void compress_vertices_standford_bunny_no_swizzling(const char* filename)
    {
  ...
  void compress_vertices_standford_bunny_zlib(const char* filename)
    {
  ...
  void compress_vertices_standford_bunny_lz4(const char* filename)
    {
