...
#define HASH1D_SIZE_EXPONENT 20
  ...
  */
  ...
  namespace
    ...
    inline uint64_t compute_hash1(uint64_t hash, uint64_t value)
      {
      return ((hash << HASH1D_SIZE_EXPONENT) ^ (value >> (64 - HASH1D_SIZE_EXPONENT))) & HASH1D_MASK;
    ...
    inline uint64_t compute_hash2(uint64_t hash, uint64_t value)
      {
      return ((hash << HASH2D_SIZE_EXPONENT/2) ^ (value >> (64 - HASH2D_SIZE_EXPONENT))) & HASH2D_MASK;
